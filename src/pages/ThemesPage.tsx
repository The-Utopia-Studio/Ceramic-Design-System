...
const pageCopy = {
  ...
  ko: {
    eyebrow: '테마',
    title: '하나의 안정적인 시스템, 다양한 테마 구현.',
    intro: 'Ceramic 코어는 시맨틱 역할, 컴포넌트 동작, 접근성, AI 계약, 아랍어 지원을 소유합니다. 테마는 재사용 컴포넌트를 다시 작성하지 않고 브랜드 값과 정책을 제공합니다.',
    defaultTheme: '기본 테마',
    brandTheme: '브랜드 테마',
    locked: '잠김',
    active: '활성',
    ...
    iconPolicy: '아이콘 정책',
    coreBoundary: '코어 경계',
    coreBoundaryTitle: '코어는 브랜드 스타일을 소유하지 않습니다.',
    semanticContract: '필수 역할',
    semanticContractTitle: '안정적인 시맨틱 계약',
    semanticContractBody: '향후 테마는 프리미티브와 확장 토큰을 추가할 수 있지만, 모든 필수 시맨틱 역할과 컴포넌트 동작을 유지해야 합니다.',
    colorRoles: '컬러 역할',
    marketingTypography: '마케팅·세일즈 타이포그래피',
    appTypography: '앱·웹사이트 타이포그래피',
    createEyebrow: '테마 저작',
    createTitle: '컴포넌트를 포크하지 않고 브랜드 테마를 만드세요.',
    createBody: '디자인 시스템 작업 공간에서 스캐폴드를 실행하고, 임시 프리미티브를 교체한 뒤 발행 전 카탈로그를 동기화하고 검증하세요.',
    copyCommand: '명령어 복사',
    copied: '복사됨',
    createSteps: [['스캐폴드', '테마 CSS, 정책 manifest, 카탈로그 등록을 생성합니다.'], ['정의', '임시 컬러, 타이포그래피, 기하, 아이콘, 모션, 아랍어 규칙을 교체합니다.'], ['검증', 'CLI 데이터를 동기화하고 빌드, 컴포넌트 감사, Ceramic doctor를 실행합니다.']],
  },
  ar: {
    eyebrow: 'الثيمات',
