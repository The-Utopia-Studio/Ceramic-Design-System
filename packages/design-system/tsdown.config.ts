...
export default defineConfig({
  entry: [
    ...
    'src/AssistantPanel.ts', 'src/Badge.ts', 'src/Button.ts', 'src/ButtonGroup.ts', 'src/Card.ts', 'src/Chat.ts',
    ...
    'src/Navigation.ts', 'src/ShadcnPrimitives.ts', 'src/Sidebar.ts', 'src/Surface.ts', 'src/ToolConnector.ts',
